...
class ProjectProfile extends Component {
    ...
    componentDidMount() {
        ...
        //console.log(id);
        axios.get(`https://hakunamatatasite.herokuapp.com/api/projects/${id}`).then(res => {
    ...
    handleClickCA =()=> {
        ...
        const data = {
            ...
            axios.put(`https://hakunamatatasite.herokuapp.com/api/consultancyAgencies/applyForProject/${memberId}`, data).then(res =>{
                swal({
                    title: "Done",
                    text: res.data.msg,
                    icon: "success",
                  })
                  window.location.href =`https://hakunamatatasite.herokuapp.com/projects/${id}`
                }
                ).catch(e => {
                    swal({
                        title: "Oh",
    ...
    handleClickMember =()=> {
        ...
        const data = {
            ...
            axios.put(`https://hakunamatatasite.herokuapp.com/api/members/applyForProject/${memberId}`, data).then(res =>{
                swal({
                    title: "Done",
                    text: res.data.msg,
                    icon: "success",
    ...
    assignMember = (memberId,state) =>{
        ...
        //console.log(data)
        axios.put(`https://hakunamatatasite.herokuapp.com/api/projects/assignMemberToProject/${id}`, data).then(res =>{
            swal({
                title: "Done",
                text: res.data.msg,
                icon: "success",
    ...
    assignConsultancyAgency = (memberId,state) =>{
        ...
        //console.log(data)
        axios.put(`https://hakunamatatasite.herokuapp.com/api/partners/assignConstlancyAgencyToProject/${this.props.auth.user._id}`, data).then(res =>{
            swal({
                title: "Done",
                text: res.data.msg,
                icon: "success",
                ...
                <div style={{
                    ...
                    <Card style={{ marginBottom: 7, paddingLeft: 5, border: 'none' }} >
                        ...
                        <IdentityCard ownerPath={this.state.project.projectPartner.id} displayedName={this.state.project.projectPartner.name} date={this.state.project.uploadDate} onClick={()=>{
                            window.location.href=`https://hakunamatatasite.herokuapp.com/updateProject/${this.props.match.params.id}`
