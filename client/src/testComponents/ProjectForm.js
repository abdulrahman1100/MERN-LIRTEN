...
class ProjectForm extends Component {
    ...
    handleSubmit(event) {
        ...
        axios.post("https://hakunamatatasite.herokuapp.com/api/projects/", data).then(res =>{
        swal({
            title: "Done",
            text: res.data.msg,
            icon: "success",
          })
          window.location.href =`https://hakunamatatasite.herokuapp.com/projects/${res.data.data._id}`}
