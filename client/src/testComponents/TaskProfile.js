...
class TaskProfile extends Component {
    ...
    //         axios.put(`https://hakunamatatasite.herokuapp.com/api/members/applyForTask/${tempId}`, data).then(res =>{
    //             swal({
    //                 title: "Done",
    //                 text: res.data.msg,
    //                 icon: "success",
    //               })
    //               window.location.href =`https://hakunamatatasite.herokuapp.com/tasks/${id}`
    //             }
    //             ).catch(e => {
    //                 swal({
    //                     title: "Oh",
    ...
    //         axios.put(`https://hakunamatatasite.herokuapp.com/api/consultancyAgencies/applyForTask/${tempId}`, data).then(res =>{
    //             swal({
    //                 title: "Done",
    //                 text: res.data.msg,
    //                 icon: "success",
    ...
    handleClickCA =()=> {
        ...
        axios.put(`https://hakunamatatasite.herokuapp.com/api/consultancyAgencies/applyForTask/${memberId}`, data).then(res =>{
                swal({
                    title: "Done",
                    text: res.data.msg,
                    icon: "success",
    ...
    handleClickMember =()=> {
        ...
        const data = {
            ...
            axios.put(`https://hakunamatatasite.herokuapp.com/api/members/applyForTask/${memberId}`, data).then(res =>{
                swal({
                    title: "Done",
                    text: res.data.msg,
                    icon: "success",
    ...
    getInfo() {
        ...
        if (this.state.task.workCycle!=undefined)
            returnedArr.push(
                <Container style={containerStyle} fluid>
    ...
    assignMember = (memberId,state) =>{
        ...
        //console.log(data)
        axios.put(`https://hakunamatatasite.herokuapp.com/api/tasks/assignMemberToTask/${id}`, data).then(res =>{
            swal({
                title: "Done",
                text: res.data.msg,
                icon: "success",
    ...
    assignConsultancyAgency = (memberId,state) =>{
        ...
        //console.log(data)
        axios.put(`https://hakunamatatasite.herokuapp.com/api/partners/assignConstlancyAgencyToTask/${this.props.auth.user._id}`, data).then(res =>{
            swal({
                title: "Done",
                text: res.data.msg,
                icon: "success",
    ...
    getApplyBtn=()=>{
        ...
        if(this.state.task.consultyNeeded){
            console.log(1)
            console.log(this.state.task.consultancyAgency)
            console.log(memberTags.includes("ConsultancyAgency"))
        ...
        console.log(3)
        console.log(this.state.task.taskMember)
        console.log(memberTags.includes("Member"))
        ...
        if (this.state.task) {
            return (
                ...
                <Card style={{ marginBottom: 7, paddingLeft:5 ,border:'none'}} >
                            ...
                            window.location.href=`https://hakunamatatasite.herokuapp.com/updateTask/${this.props.match.params.id}`
