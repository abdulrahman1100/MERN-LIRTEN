...
class ProjectUpdate extends Component {
    ...
    handleDelete(){
        ...
        axios.delete(`https://hakunamatatasite.herokuapp.com/api/projects/${id}`).then(res =>{
        swal({
            title: "Done",
            text: res.data.msg,
            icon: "success",
    ...
    onSubmit(event) {
        ...
        axios.put(`https://hakunamatatasite.herokuapp.com/api/projects/${id}`, data).then(res =>{
        swal({
            title: "Done",
            text: res.data.msg,
            icon: "success",
