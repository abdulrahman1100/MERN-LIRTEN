...
class TaskForm extends Component {
 ...
 if(this.props.isProject){
    ...
    //console.log(id);
    axios.post(`https://hakunamatatasite.herokuapp.com/api/projects/task/${id}`, data).then(res =>{
    swal({
        title: "Done",
        text: res.data.msg,
        icon: "success",
      })
      window.location.href =`https://hakunamatatasite.herokuapp.com/tasks/${res.data.data._id}`
    ...
    axios.post("https://hakunamatatasite.herokuapp.com/api/tasks/", data).then(res =>{
    swal({
        title: "Done",
        text: res.data.msg,
        icon: "success",
