...
onClick(){
  ...
  axios
  .post(`https://hakunamatatasite.herokuapp.com/api/posts`,{
  ...
  axios
  .post(`https://hakunamatatasite.herokuapp.com/api/courseRequests`,{
  ...
  axios
  .put(`https://hakunamatatasite.herokuapp.com/api/consultancyAgencies/report/${id}`,{
      ...
      <div style={{ marginBottom: '13px' }}>
        ...
        <div style={{paddingLeft:10}}>
          <Nav variant="tabs" defaultActiveKey="/HomePage" onSelect={k => this.handleSelect(k)} >
            <Nav.Item>
              <Nav.Link eventKey="post" style={{color:"#17a2b8"}}>Post</Nav.Link>
            </Nav.Item>
            <Nav.Item>
              <Nav.Link eventKey="courseRequest" style={{color:"#17a2b8"}}>Course Request</Nav.Link>
            </Nav.Item>
            <Nav.Item>
              <Nav.Link eventKey="report" style={{color:"#17a2b8"}}> Report </Nav.Link>
            </Nav.Item>
          </Nav>
          </div>
          <br />
