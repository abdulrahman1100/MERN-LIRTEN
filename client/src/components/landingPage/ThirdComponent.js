  ...
  firstHandleClick(){
    if (this.props.type==='Task') {
      ...
      console.log(data.taskId)
       axios.put(`https://hakunamatatasite.herokuapp.com/api/members/applyForTask/${store.get("payload").id}`,data)
    }
    else if(this.props.type==='Project'){
      const data={
        projectId:this.props.id,
      }
       axios.put(`https://hakunamatatasite.herokuapp.com/api/members/applyForProject/${this.props.memberId}`,data)
    }
  }
  secondHandleClick(){
