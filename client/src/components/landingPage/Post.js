    ...
    super(props)
      ...
      handleSubmit(){
        ...
        if(this.state.report){
          axios
          .put(`https://hakunamatatasite.herokuapp.com/api/consultancyAgencies/report/${store.get("payload").id}`,{
          ...
          if(this.state.courseRequest){
            ...
            if(this.state.post){
              ...
              if(this.state.event){
                axios
                .put(`https://hakunamatatasite.herokuapp.com/api/consultancyAgencies/event/${store.get("payload").id}`,{
