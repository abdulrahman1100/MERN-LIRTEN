...
export class CreateTask extends Component {
  ...
  async handleClick() {
    ...
    console.log('helloo')
    await axios
      .get(`https://hakunamatatasite.herokuapp.com/api/partners/${id}`)
    ...
    console.log(data)
     await axios.post("https://hakunamatatasite.herokuapp.com/api/tasks/", data).catch(e => {
        alert('error ')
      }).then(alert('Done: '));
  }
  getStyle = () => {
  ...
  componentDidMount() {
    axios
      .get("https://hakunamatatasite.herokuapp.com/api/tasks/skills")
