...
import Select from "../../../../node_modules/react-select/lib";
...
export class CreateTask extends Component {
  ...
  async handleClick() {
    ...
    await axios.put(`https://https://hakunamatatasite.herokuapp.com/api/tasks/${id}`, data);
  }
  getStyle = () => {
    return {
      background: "#242424",
  ...
  async componentDidMount() {
    const { id } = this.props.match.params;
    await axios.get(`https://https://hakunamatatasite.herokuapp.com/api/tasks/${id}`).then(res => this.setState({ descriptioninput: res.data.data.description }))
    console.log(this.state.descriptioninput)
   await axios
      .get("https://https://hakunamatatasite.herokuapp.com/api/tasks/skills")
