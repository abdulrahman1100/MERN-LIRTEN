  ...
  renderRedirect = () => {
    if (this.state.search) {
      if(this.state.educator.value=="tasks"){
        window.location.href ="https://hakunamatatasite.herokuapp.com/tasks"
      return <Redirect to='/tasks' />}
      if(this.state.educator.value=="projects"){
        window.location.href ="https://hakunamatatasite.herokuapp.com/projects"

      return <Redirect to='/projects' />
            }      if(this.state.educator.value=="courses"){
              window.location.href ="https://hakunamatatasite.herokuapp.com/courses"

      return <Redirect to='/courses' />}
      if(this.state.educator.value=="members"){
        window.location.href ="https://hakunamatatasite.herokuapp.com/members"

      return <Redirect to='/members' />
    }
      if(this.state.educator.value=="partners"){
        window.location.href ="https://hakunamatatasite.herokuapp.com/partners"

      return <Redirect to='/partners' />
    }
      if(this.state.educator.value=="masterClasses"){
        window.location.href ="https://hakunamatatasite.herokuapp.com/masterClasses"

      return <Redirect to='/masterClasses' />
      }
      if(this.state.educator.value=="trainingPrograms"){
        window.location.href ="https://hakunamatatasite.herokuapp.com/trainingPrograms"

      return <Redirect to='/trainingPrograms' />
    }
      if(this.state.educator.value=="consultancyAgencies"){
        window.location.href ="https://hakunamatatasite.herokuapp.com/consultancyAgencies"

      return <Redirect to='/consultancyAgencies' />
    }
      if(this.state.educator.value=="educationOrganizations"){
        window.location.href ="https://hakunamatatasite.herokuapp.com/educationOrganizations"

      return <Redirect to='/educationOrganizations' />
    }
      if(this.state.educator.value=="coworkingSpaces"){
        window.location.href ="https://hakunamatatasite.herokuapp.com/coworkingSpaces"
