...
class Card extends Component {
  ...
  handleClick(){
    ...
    console.log(data.taskId + ' '+store.get("payload").id)
     axios.put(`https://hakunamatatasite.herokuapp.com/api/members/applyForTask/${store.get("payload").id}`,data).catch(e => {
      alert(e)
    }).then(alert('Done: '))
  }
    ...
    console.log(data.taskId + ' '+store.get("payload").id)
     axios.put(`https://hakunamatatasite.herokuapp.com/api/consultancyAgencies/applyForTask/${store.get("payload").id}`,data).catch(e => {
      alert(e)
    }).then(alert('Done: '))
