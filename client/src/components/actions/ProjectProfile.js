...
import { Container, Col } from "../../../../node_modules/react-bootstrap";
...
class Card extends Component {
  ...
  componentDidMount() {
    ...
    console.log(id);
    axios.get(`https://https://hakunamatatasite.herokuapp.com/api/projects/${id}`).then(res => {
      this.setState({
  ...
  handleClick(){
    ...
    console.log(data.projectId + ' '+store.get("payload").id)
     axios.put(`https://https://hakunamatatasite.herokuapp.com/api/members/applyForProject/${store.get("payload").id}`,data).catch(e => {
      alert(e)
    }).then(alert('Done: '))
  }else
...
const data={
  ...
  console.log(data.projectId + ' '+store.get("payload").id)
   axios.put(`https://https://hakunamatatasite.herokuapp.com/api/consultancyAgencies/applyForProject/${store.get("payload").id}`,data).catch(e => {
    alert(e)
  }).then(alert('Done: '))
}
  // }
